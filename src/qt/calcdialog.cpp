...
void calcDialog::pushButtonClicked()
{
    ...
    if(nUserAmount * nTargetDays < nAverageWeight)
    {
        ...
        ui->avgWeightResult->setText(strAvgSize + QString(" It is recommended that you do not split your MCH. %1 MCH will yield a weight of <b>%2</b> on day %3, which is %4 less weight than the average weight staked in the last %5 blocks.")
    ...
    ui->avgWeightResult->setText(strAvgSize + QString(" It is recommended that you split your %1 MCH into <b>%2 outputs of %3 MCH</b>. This will yield a weight of <b>%4</b> on day %5.")
                            .arg(us.toString(nUserAmount))
